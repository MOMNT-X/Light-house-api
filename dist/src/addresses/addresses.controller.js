...
let AddressesController = class AddressesController {
    ...
    create(user, createData) {
        return this.addressesService.create(user.userId, createData);
    }
    update(user, id, updateData) {
        return this.addressesService.update(user.userId, id, updateData);
    }
    remove(user, id) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, addresses_dto_1.UpdateAddressDto]),
    __metadata("design:returntype", void 0)
